...
?>
				<tbody id="table-fajar">
					<tr>
						<td><?php echo $no++ ?></td>
						<td><?php echo $fajar['username'] ?></td>
						<td><?php echo $fajar['password'] ?></td>
						<td><?php echo $fajar['nama_level'] ?></td>
						<td><?php echo $fajar['status'] ?></td>
						<td>
							<a href="edit_user.php?id=<?php echo $fajar['id_user'] ?>">EDIT</a>
							<a href="hapus_user.php?id=<?php echo $fajar['id_user'] ?>">HAPUS</a>
						</td>
					</tr>
				</tbody>
<?php
